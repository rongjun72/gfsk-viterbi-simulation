function gfsk_4ary_viterbi_isi()
% gfsk_4ary_viterbi_isi.m
% 4-ary GFSK coherent demodulation + ISI-aware Viterbi sequence detection
%
% Architecture:
...
fprintf('=== 4-ary GFSK + ISI-Aware Viterbi Sequence Detection ===\n');
...
%% ========================================================================
    function det_gray = viterbi_decode_isi(obs_matrix)
        ...
        det_gray = det_gray - 1;  % 0-based Gray
    end
...
title(sprintf('4-ary GFSK: Hard vs ISI-Aware Viterbi (h=%.1f, BT=%.1f, nsps=%d)', h, BT, nsps));
...
% Figure 3: Single waveform illustration
...
%% ========================================================================
fprintf('\n========== RESULT SUMMARY ==========\n');
fprintf('Eb/N0(dB) | Hard BER  | Vit-ISI BER | Vit Gain(dB) | Theory BER\n');
fprintf('----------|-----------|-------------|--------------|------------\n');
for idx = 1:length(EbN0_dB)
    gain = 10*log10(BER_hard(idx)/BER_vit(idx));
